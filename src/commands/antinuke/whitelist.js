...
To enable use antinuke enable ** `);
            ...
            if (!member)
                return message.channel.send({ embeds: [wl] });
                ...
                if (data.ban &&
                    ...
                    return message.channel.send({
                        embeds: [
                            client.util.embed()
                                .setColor(client.color)
                                .setDescription(`${client.emoji.cross} | <@${member.id}> is already a whitelisted member.`)
                        ]
                    });
            }
