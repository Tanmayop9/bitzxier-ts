...
export default {
    ...
    run: async (client, message, args) => {
        ...
        const antinuke = client.util.embed()
            ...
            .setDescription(`Level up your server security with Antinuke! It swiftly bans admins engaging in suspicious activities, all while safeguarding your whitelisted members. Enhance protection – enable Antinuke now!`)
            .addFields([
            {
        ...
        if (!option) {
            ...
            if (isActivatedAlready) {
                ...
                if (message.guild.roles.cache.size > 249)
                    return message.reply(`I Won't Able To Create \`Bitzxier Impenetrable Power\` Cause There Are Already 249 Roles In This Server`);
...
//# sourceMappingURL=antinuke.js.map