...
export default {
    ...
    run: async (client, message, args) => {
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`${client.emoji.cross} | Only Server Owner Can Run This Command!`),
                ],
            });
        ...
        const antinuke = client.util.embed()
            ...
            .setDescription(`ExtraOwner Can Edit Server Antinuke Status Whitelisted Members So Be Careful Before Adding Someone in it`)
            .addFields([
...
//# sourceMappingURL=extraowner.js.map