            ...
            if (!option) {
                ...
                if (panic) {
                    ...
                    let msg = await message.channel.send({
                        embeds: [
                            client.util.embed()
                                .setColor(client.color)
                                .setDescription(`${client.emoji.tick} | Initializing Panic Setup!`)
                        ]
                    });
                    const steps = [
                ...
                if (punishment === 'ban') {
                    ...
                    const panicModeEmbed = client.util.embed()
                        ...
                        .setDescription('Panic Mode punishment has been successfully set to ban.')
                ...
                if (punishment === 'quarantine') {
                    ...
                    const quarantinePunishmentEmbed = client.util.embed()
                        ...
                        .setDescription('Panic Mode punishment has been successfully set to quarantine.')
...
//# sourceMappingURL=panicmode.js.map