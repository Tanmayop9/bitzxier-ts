        ...
        try {
                ...
                try {
                    if (!args[0]) {
                        const opp = client.util.embed()
                            ...
                            .setDescription(`${client.emoji.cross} | You didn't provided the command name.`);
            ...
            if (reload) {
                const op = client.util.embed()
                    .setColor(client.color)
                    .setDescription(`${client.emoji.tick} | Successfully reloaded \`${args[0]}\``);
                return message.channel.send({ embeds: [op] });
            }
            const notop = client.util.embed()
                .setColor(client.color)
                .setDescription(`${client.emoji.cross} | I was unable to reload \`${args[0]}\``);
...
//# sourceMappingURL=reloadcmd.js.map