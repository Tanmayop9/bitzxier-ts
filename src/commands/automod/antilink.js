export default {
    ...
    run: async (client, message, args) => {
        ...
        const option = args[0];
        const isActivatedAlready = (await client.db.get(`antilink_${message.guild.id}`)) || null;
        const antilink = client.util.embed()
            .setThumbnail(client.user.avatarURL({ dynamic: true }))
            .setColor(client.color)
            .setTitle('__**Antilink**__')
            .setDescription("Enhance your server's protection with Antilink! Our advanced algorithms swiftly identify suspicious links and take immediate action against them, safeguarding your community from potential threats.")
            .addFields([
            {
            ...
            case 'enable':
                if (!isActivatedAlready) {
                    ...
                    const antilinkEnableMessage = client.util.embed()
                        ...
                        .setDescription('**Congratulations! Antilink has been successfully enabled on your server.**')
                        .addFields({
                    ...
                    const antilinkSettingsEmbed = client.util.embed()
                        .setTitle(`Antilink Settings for ${message.guild.name} ${protect}`)
                        .setColor(client.color)
                        .setDescription('**Antilink is already enabled on your server.**')
                        .addFields({
                        name: 'Current Status',
            ...
            case 'disable':
                if (isActivatedAlready) {
                    ...
                    const antilinkDisableMessage = client.util.embed()
                        ...
                        .setDescription('**Antilink has been successfully disabled on your server.**')
                        .addFields({
                        name: 'Impact',
            ...
            case 'punishment':
                ...
                if (punishment === 'mute') {
                    ...
                    const embedMessage = client.util.embed()
                        ...
                        .setDescription('The antilink punishment has been successfully configured.')
