const enable = `<:bitzxier_disable_no:1180518054518587454><:bitzxier_enable_yes:1180431183620882472>`;
const disable = `<:biztxier_disable_yes:1180432405501333617><:bitzxier_enable_no:1180432231282516050>`;
const protect = `<a:bitzxier_antinuke:1180431827438153821>`;
const hii = `<:bitzxier:1180449001934442516>`;
export default {
    name: 'antispam',
    aliases: [],
    cooldown: 5,
                ...
                case 'strikes':
                    ...
                    if (!strikes) {
                        const embedMessage = client.util.embed()
                            ...
                            .setDescription(`**Error:** Please provide valid strikes arguments.`)
                            .addFields({
                            name: 'Example',
                    ...
                    if (strikes >= 1 && strikes <= 10) { // Updated condition to accept only numbers from 1 to 10
                        ...
                        const embedMessage = client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.tick} | **Spam Warnings Updated**`)
