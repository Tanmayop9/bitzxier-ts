...
export default {
    ...
    run: async (client, message, args) => {
        ...
        if (option.toLowerCase() === 'setup') {
            ...
            await GuildConfig.findOneAndUpdate({ guildId: message.guild.id }, { guildId: message.guild.id, hubChannelId: hubChannel.id, categoryId: category.id, interfaceChannelId: interfaceChannel.id }, { upsert: true });
...
//# sourceMappingURL=jointocreate.js.map