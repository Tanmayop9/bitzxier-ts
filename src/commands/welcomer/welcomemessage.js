        ...
        if (!args[0]) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`You have to provide the required arguments.\nOptions: \`autodel\`, \`color\`, \`description\`, \`thumbnail\`, \`title\``)
                ]
            });
        }
        ...
        if (option == 'autodel') {
            ...
            if (!args[0] || isNaN(time)) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`You didn't provided valid seconds of autodelete.\nFor disabling autodel: \`0\`.\nFor autodel: \`<1 - 30>\``)
                    ]
                });
            }
            if (time > 30 || time < 0) {
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`Updated the welcome message's auto-delete time to \`${time}s\`.`)
                ]
            });
        }
        if (option == 'color') {
            ...
            if (!color || !client.util.isHex(color)) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`You must provide a valid hex code for welcome embed.`)
                    ]
                });
            }
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`Updated the embed's color configuration to \`${color}\`.`)
                ]
            });
        }
            ...
            if (!args[1]) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`You didn't provide the status of thumnail.\nStatus: \`on\`, \`off\``)
                    ]
                });
            }
            ...
            if (!['ON', 'OFF'].includes(status)) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`You didn't provide a valid status of thumbnail.\nStatus: \`on\`, \`off\``)
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setDescription(`Please Provied Valid Link`)
                    ]
                });
            }
