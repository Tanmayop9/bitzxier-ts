        ...
        if (channel.id === message.member.voice.channel.id) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.cross} | your providing same voice channel as you.`)
                ]
            });
        }
        try {
            ...
            await message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.tick} | Successfully Moved ${i} Members to ${channel}!`)
                ]
            });
        }
        catch (err) {
...
//# sourceMappingURL=vcmoveall.js.map