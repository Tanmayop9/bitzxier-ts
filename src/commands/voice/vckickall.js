        ...
        try {
            ...
            message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.tick} | Successfully Disconnected ${i} Members from ${message.member.voice.channel}!`)
                ]
            });
        }
        catch (err) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`I don't have the required permissions to disconnect members.`)
                ]
            });
        }
    }
};
//# sourceMappingURL=vckickall.js.map