        ...
        if (!member) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`Please Proide a valid member`)
                ]
            });
        }
        if (!member.voice.channel) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`provided member is not connected to voice channel.`)
                ]
            });
        }
        if (member.voice.channel.id === message.member.voice.channel.id) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.cross} | did you think i am dumb ? you both are in same voice channel`)
                ]
            });
        }
        try {
            ...
            await message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.tick} | Successfully Moved ${member} Members to ${message.member.voice.channel}!`)
                ]
            });
        }
        catch (err) {
...
//# sourceMappingURL=vcpull.js.map