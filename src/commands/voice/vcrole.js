            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`You must have \`Administration\` perms to run this command.`)
                ]
            });
        }
        const invc = client.util.embed()
            .setColor(client.color)
            .setAuthor({
                ...
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setDescription(`Please provide valid role arguments: \`set\`.`)
                    ]
                });
            }
                ...
                await client.db
                    ...
                    if (!data) {
                        ...
                        const saiop = client.util.embed()
                            .setColor(client.color)
                            .setDescription(`Great news! Your server is now configured perfectly. Feel free to use vcrole module and enjoy using your server hassle-free! 🚀`);
                        return await msg.edit({ embeds: [saiop] });
                    }
                    if (role) {
                        if (role &&
                            !role.permissions.has('Administrator', 'KICK_MEMBERS', 'BanMembers', 'MANAGE_CHANNELS', 'ManageGuild', 'MENTION_EVERYONE', 'ManageRoles', 'ManageWebhooks')) {
                            await client.db.set(`vcroles_${message.guild.id}`, {
                                vcrole: role.id,
                            ...
                            message.channel.send({
                                embeds: [
                                    client.util.embed()
                                        .setColor(client.color)
                                        .setDescription(`${client.emoji.tick} | successfully added ${role} as vcrole human.!`)
                                ]
                            });
                        }
                        else {
                            message.channel.send({
                                embeds: [
                                    client.util.embed()
                                        .setColor(client.color)
                                        .setDescription(`${client.emoji.cross} | this role is having dangerous permissions.!`)
                                ]
                            });
                        }
                    }
                    if (!role) {
                        return message.channel.send({
                            embeds: [
                                client.util.embed()
                                    .setColor(client.color)
                                    .setDescription(`${client.emoji.cross} | please provide a valid role mention or id to set as vcrole!`)
                            ]
                        });
                    }
                    if (role.position >=
                    ...
                    if (role.managed) {
                        return message.channel.send({
                            embeds: [
                                client.util.embed()
                                    .setColor(client.color)
                                    .setDescription(`${client.emoji.cross} | you cannot add any integrated role in My vcrole.! `)
                            ]
                        });
                    }
                });
                        ...
                        if (role &&
                            ...
                            message.channel.send({
                                embeds: [
                                    client.util.embed()
                                        .setColor(client.color)
                                        .setDescription(`${client.emoji.tick} | successfully added ${role} as vcrole bot.!`)
                                ]
                            });
                        }
                        else {
                ...
                if (!data.vcrole && !data.vcrolebot) {
                    return message.channel.send({
                        embeds: [
                            client.util.embed()
                                .setColor(client.color)
                                .setDescription(`${client.emoji.cross} | No vcrole is configured.!`)
                        ]
                    });
                }
                else {
                ...
                if (!data.vcrole && !data.vcrolebot) {
                    message.channel.send({
                        embeds: [
                            client.util.embed()
                                .setColor(client.color)
                                .setDescription(`${client.emoji.cross} | there is no vcrole in this server.!`)
                        ]
                    });
                }
                else if (data
                    ...
                    message.channel.send({
                        embeds: [
                            client.util.embed()
                                .setColor(client.color)
                                .setDescription(`${client.emoji.tick} | successfully disabled vcrole configuration.!`)
                        ]
                    });
                }
            });
...
if (option.toLowerCase() === 'set') {
    ...
    if (role && !role.permissions.has('Administrator','KICK_MEMBERS','BanMembers','MANAGE_CHANNELS','ManageGuild','MENTION_EVERYONE','ManageRoles','ManageWebhooks')) {
        await client.db.set(`vcroles_${message.guild.id}`, {
            vcrole : role.id
        })
        message.channel.send({
...
//# sourceMappingURL=vcrole.js.map