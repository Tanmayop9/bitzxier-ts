            ...
            collector.on('collect', async (i) => {
                ...
                if (i.isButton()) {
                    if (i.customId == 'latencyGraph') {
                        ...
                        if (msg)
                            return msg.edit({ embeds: [graphEmbed], components: [row1] });
                    }
                    ...
                    if (i.customId == 'partners') {
                        ...
                        const em = client.util.embed()
                            ...
                            .setDescription(`RudraCloud was born in 2023 with the idea of providing the latest generation products to customers. We provide **Virtual Private Servers**, **Panels**, Virtual Dedicated Servers, and Dedicated Servers [click here to see website](https://rudracloud.xyz/)\n[discord server](https://discord.com/invite/MGmmsj7tCJ)`)
                            .setFooter({
                        ...
                        const row1 = new ActionRowBuilder().addComponents([button, button1, button2, button3, buttonGraph]);
                        if (msg)
                            return msg.edit({ embeds: [em], components: [row1] });
                    }
                    // Handle Team button
                    if (i.customId == 'team') {
                        i.deferUpdate();
                    ...
                    if (i.customId == 'system') {
                            ...
                            msg.edit({
                                embeds: [
                                    client.util.embed()
                                        ...
                                        .setDescription('<:bitzxier_mainrole:1181290802022977576> | **Fetching** all the **resources**...')
                                ],
                                components: [row]
                            });
                        ...
                        const startUsage1 = cpuUsage1.user +
                            cpuUsage1.nice +
                            cpuUsage1.sys +
                            cpuUsage1.irq;
                        let cpuUsage2;
                        setTimeout(async () => {
                            ...
                            const endUsage1 = cpuUsage2?.user +
                                cpuUsage2?.nice +
                                cpuUsage2?.sys +
                                cpuUsage2?.irq;
                            ...
                            if (msg)
                                return msg.edit({ embeds: [embed1], components: [row1] }, message, msg);
                        }, 2000);
                    }
                }
            });
