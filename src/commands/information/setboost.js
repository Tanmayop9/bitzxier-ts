            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`${client.emoji.cross} | You didn't provided a valid channel.`)
                ]
            });
        }
        if (!disable)
        ...
        if (!disable && !hasPerms) {
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.cross} | I didn't have permissions to send messages in <#${channel.id}>.`)
                ]
            });
        }
...
//# sourceMappingURL=setboost.js.map