    ...
    run: async (client, message, args) => {
        ...
        if (!message.member.permissions.has('ManageRoles')) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | You must have \`Manage Roles\` permissions to use this command.`)
                ]
            });
        }
        ...
        if (!message.guild.members.me.permissions.has('ManageRoles')) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | I don't have \`Manage Roles\` permissions to execute this command.`)
                ]
            });
        }
        ...
        if (message.author.id !== message.guild.ownerId && message.member.roles.highest.position <= message.guild.members.me.roles.highest.position) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | You must have a higher role than me to use this command.`)
                ]
            });
        }
        ...
        if (premiumTier < 2) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | Your server doesn't meet the **Roleicon** requirements. Servers with level **2** boosts are allowed to set role icons.`)
                ]
            });
        }
        ...
        if (!args[0]) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | Usage: ${message.guild.prefix}roleicon <role> <emoji>`)
                ]
            });
        }
        ...
        if (!role) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | Provide a valid role.`)
                ]
            });
        }
        ...
        if (role.position >= message.guild.members.me.roles.highest.position) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | ${role} is higher or equal in the role hierarchy than my highest role.`)
                ]
            });
        }
        ...
        if (role.iconURL() && !args[1]) {
            try {
                ...
                return message.channel.send({
                    embeds: [
                        sai.setDescription(`${client.emoji.tick} | Successfully removed icon from ${role}.`)
                    ]
                });
            }
            catch (err) {
                return message.channel.send({
                    embeds: [
                        sai.setDescription(`${client.emoji.cross} | An error occurred while removing the icon.`)
                    ]
                });
            }
        }
        ...
        if (!args[1]) {
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | Provide an emoji.`)
                ]
            });
        }
        ...
        try {
            ...
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.tick} | Successfully set the icon for ${role}.`)
                ]
            });
        }
        catch (err) {
            ...
            return message.channel.send({
                embeds: [
                    sai.setDescription(`${client.emoji.cross} | An error occurred while setting the icon.`)
                ]
            });
        }
    }
