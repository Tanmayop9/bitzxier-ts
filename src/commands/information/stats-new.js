...
class StatsCommand extends BaseCommand {
    ...
    async execute(client, message, args) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`### ${client.emoji.hii} Hello, I'm Friday!\n\n` +
            `A powerful and modern Discord bot designed for server management, ` +
            `security, and automation.`)
            .addFields({
            name: '📊 General Statistics',
            value: `${client.emoji.dot} **Servers:** \`${guilds.toLocaleString()}\`\n` +
            ...
            name: '⚡ Performance',
            value: `${client.emoji.dot} **Uptime:** \`${this.formatUptime(uptime)}\`\n` +
            ...
            name: '🛠️ Technical',
            value: `${client.emoji.dot} **Platform:** \`${platform}\`\n` +
        ...
        collector.on('collect', async (interaction) => {
            if (interaction.customId === 'stats_system') {
                const systemEmbed = new EmbedBuilder()
                    ...
                    .setFooter({ text: 'Author: Tanmay | Recoded by Nerox Studios | v2-alpha-1' })
                    .setTimestamp();
                const newButtons = new ActionRowBuilder().addComponents(new ButtonBuilder()
                    .setLabel('General')
                    .setCustomId('stats_general')
                    .setStyle(ButtonStyle.Primary)
        ...
        collector.on('end', () => {
            const disabledButtons = new ActionRowBuilder().addComponents(new ButtonBuilder()
                .setLabel('General')
                .setCustomId('stats_general')
                .setStyle(ButtonStyle.Primary)
                .setEmoji('📊')
...
//# sourceMappingURL=stats-new.js.map