...
export default {
    ...
    run: async (client, message, args) => {
        ...
        let embed = new EmbedBuilder()
            ...
            .setDescription(`[\`PNG\`](${member.displayAvatarURL({
            forceStatic: false,
            size: 2048,
            extension: 'png'
        ...
        if (hasServerAvatar) {
            ...
            collector.on('collect', async (interaction) => {
                if (!['avatar', 'server_avatar'].includes(interaction.customId))
                    return;
                ...
                if (interaction.customId === 'avatar') {
                    ...
                    embed.setDescription(`[\`PNG\`](${member.displayAvatarURL({
                        forceStatic: false,
                        size: 2048,
                        extension: 'png'
                    })}) | [\`JPG\`](${member.displayAvatarURL({
                    ...
                    embed.setDescription(`[\`PNG\`](${guildMember.displayAvatarURL({
                        forceStatic: false,
                        size: 2048,
                        extension: 'png'
