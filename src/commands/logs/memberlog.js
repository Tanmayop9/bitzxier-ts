                ...
                await message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .addFields({ name: 'Types of Member Logging Enabled', value: '\`Member Join\`\n\`Member Leave\`\n\`Member Role Update\`' })
                            .addFields({ name: 'What happens now?', value: 'The bot will log member joins, leaves, and member role updates in the configured channel.' })
                    ],
                });
            }
        }
