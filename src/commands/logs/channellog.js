                ...
                await message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .addField({ name: 'Types of Channel Logging Enabled', value: '\`Channel Create\`\n\`Channel Delete\`\n\`Channel Update\`' })
                            .addField({ name: 'What happens now?', value: 'The bot will log channel creation, deletion, and updates in the configured channel.' })
                    ],
                });
            }
        }
