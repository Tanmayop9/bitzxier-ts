        ...
        if (input === 'add') {
            ...
            if (!data) {
                ...
                let msg = await message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`Please wait, setting up configuration for your server. This may take a moment...`)
                    ]
                });
                ...
                const setupRoleEmbed = client.util.embed()
                    ...
                    .setDescription(`Congratulations! Your server has been configured successfully. You can now use custom roles and enjoy the enhanced features hassle-free! 🚀`)
                    .setFooter(`Setup completed by ${message.author.tag}`, message.author.displayAvatarURL({ dynamic: true }));
            ...
            if (data) {
                ...
                if (data.names.length > limit) {
                    const embed = client.util.embed()
                        .setColor(client.color)
                        .setDescription(`${client.emoji.cross} | Sorry, you've reached the limit of ${limit} custom role setups. Please remove some setups to add new ones.`);
            ...
            if (!args[1])
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | ${message.guild.prefix}setup add <name> <role>`)
                    ]
                });
            ...
            if (mentionRegex.test(name)) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`You Cannot Add User Mentions role mentions & channel mentions in name`)
                    ]
                });
            }
            if (data)
                if (data.names.length > 0) {
                    if (data.names.includes(name)) {
                        const embed = client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | Oops! The custom role **${name}** already exists in my list. Please choose a different name.`);
                        return message.channel.send({ embeds: [embed] });
                    }
                }
            if (!args[2])
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | ${message.guild.prefix}setup add ${args[1]} <role>`)
                    ]
                });
            ...
            if (role.managed)
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | <@&${role.id}> isn't a **server** role!`)
                    ]
                });
            if (role) {
                if (data.roles.length > 0) {
                    if (data.roles.includes(role.id)) {
                        const embed = client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | Oops! The custom role **${role}** already exists in my list. Please choose a different name.`);
                        return message.channel.send({ embeds: [embed] });
                    }
                }
            }
            ...
            if (role.permissions.has('KickMembers') ||
                ...
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setDescription(`${client.emoji.cross} | I can't **add** <@&${role.id}> in my **custom role** list because it has ${new PermissionsBitField.Flags(role.permissions.bitfield)
                            .toArray()
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`The role <@&${role.id}> has been successfully added to my custom role list.`)
            ...
            if (!data.names.length) {
                const embed = client.util.embed()
                    .setColor(client.color)
                    .setDescription(`${client.emoji.cross} | Oops! It seems like there are no custom role setups configured yet. Use \`${message.guild.prefix}setup\` to create custom roles.`);
                return message.channel.send({ embeds: [embed] });
            }
            if (!args[1]) {
                return message.channel.send({
            ...
            if (roleIndex === -1) {
                const embed = client.util.embed()
                    .setColor(client.color)
                    .setDescription(`${client.emoji.cross} | Oops! The role with the name **${roleName}** couldn't be found in my custom role setups. Double-check the name and try again.`);
                return message.channel.send({ embeds: [embed] });
            }
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`The role **${roleName}** has been successfully removed from my custom role list.`)
            ...
            if (!data) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`${client.emoji.cross} | Oops! There's nothing to display for custom role setups.`)
                    .setAuthor({
                    name: message.guild.name,
                    iconURL: message.guild.iconURL({ dynamic: true }) ||
                        client.user.displayAvatarURL()
            ...
            if (data) {
                ...
                let c = 0;
                let mappedData = data.names.map((d, index) => `[\`${++c}\`] | **${message.guild.prefix}${d}**: <@&${data.roles[index]}> | \`${data.roles[index]}\`` // Correctly concatenating values
            ...
            if (!data) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`Oops! It appears there are no custom role setups configured yet. Use \`${message.guild.prefix}setup\` to create custom roles and enhance your server experience.`);
                return message.channel.send({ embeds: [embed] });
            }
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`The custom role module has been successfully reset. All custom roles, configurations, and settings have been cleared. You can now start fresh with your custom role setups.`)
                        .setFooter({
            ...
            if (!data) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`Oops! It seems like there are no custom role setups configured for this server yet. Use \`${message.guild.prefix}setup\` to create custom roles and personalize your server's roles.`)
                    .setFooter({
            ...
            if (!args[1])
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${message.guild.prefix}setup reqrole <role>`)
                    ]
                });
            const role = message.mentions.roles.first() ||
            ...
            if (!role) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`Oops! The specified role could not be found. Please double-check the role mention or name and try again.`)
                    .setFooter({
                    text: `Requested by ${message.author.tag}`,
                    value: message.author.displayAvatarURL({ dynamic: true })
                });
            ...
            if (role.managed) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`<@&${role.id}> appears to be a role managed by an internal service and cannot be assigned as a server role. Please choose a different role.`)
            ...
            if (role.position >= message.member.roles.highest.position &&
                ...
                const embed = client.util.embed()
                    ...
                    .setDescription(`<@&${role.id}> cannot be assigned because its position is either equal to or higher than your highest role. Please adjust your roles or choose a role with a lower position.`)
                    .setFooter({
                    text: `Requested by ${message.author.tag}`,
                    iconURL: message.author.displayAvatarURL({ dynamic: true })
                });
            ...
            if (role.position >= message.guild.members.me.roles.highest.position) {
                const embed = client.util.embed()
                    ...
                    .setDescription(`<@&${role.id}> cannot be assigned because its position is either equal to or higher than my highest role. Please adjust the role positions or choose a role with a lower position.`)
                    .setFooter({ text: `Requested by ${message.author.tag}`,
                    iconURL: message.author.displayAvatarURL({ dynamic: true })
                });
                return message.channel.send({ embeds: [embed] });
            ...
            return message.channel.send({
                embeds: [
                    client.util.embed()
                        ...
                        .setDescription(`The role <@&${role.id}> has been successfully set up as a custom requirement role. Members will now need this role to assign features.`)
                        .setFooter({
