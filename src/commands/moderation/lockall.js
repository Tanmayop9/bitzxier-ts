    ...
    run: async (client, message, args) => {
        ...
        if (!message.guild.lockall) {
            ...
            interactionMessage.edit({
                embeds: [
                    embed.setDescription(`**Are you sure you want to lock all channels to in this server?**`),
                ], components: [row],
            });
            ...
            collector.on('collect', async (interaction) => {
                if (interaction.isButton()) {
                    if (interaction.customId === 'yes_button') {
                        interactionMessage.edit({
                            embeds: [
                                embed.setDescription(`${client.emoji.tick} | Successfully started locking all channnels.`),
                            ],
                            components: [],
                        });
                        collector.stop();
            ...
            return message.channel.send({
                embeds: [
                    embed.setDescription(`${client.emoji.cross} | There is already a Lock all process is going on in the server.`)
                        .setColor(client.color),
                ],
            });
        }
...
//# sourceMappingURL=lockall.js.map