    ...
    run: async (client, message, args) => {
        ...
        if (!own &&
            ...
            const higherole = client.util.embed()
                .setColor(client.color)
                .setDescription(`${client.emoji.cross} | Only Server Owner Or Extra Owner Having Higher Role Than Me Can Run This Command`);
        ...
        const antinuke = client.util.embed()
            ...
            .setColor(client.color)
            .setTitle(`Modrole`)
            .setDescription(`assigning this role as the moderator role, members will gain access to a suite of powerful moderation commands:
            ...
            if (!data) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | There is no modrole configuration in this server.`)
                    ]
                });
            }
            else {
                ...
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.tick} | Successfully disabled modrole configuration.`)
                    ]
                });
            }
        }
            ...
            if (!data) {
                return message.channel.send({
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`${client.emoji.cross} | No Modrole is set.`)
                    ]
                });
            }
            else {
