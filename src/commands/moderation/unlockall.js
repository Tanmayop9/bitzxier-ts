    ...
    run: async (client, message, args) => {
        ...
        if (!message.guild.unlockall) {
            ...
            interactionMessage.edit({
                embeds: [
                    embed.setDescription(`**Are you sure you want to unlock all channels to in this server?**`),
                ], components: [row],
            });
            ...
            collector.on('collect', async (interaction) => {
                if (interaction.isButton()) {
                    if (interaction.customId === 'yes_button') {
                        interactionMessage.edit({
                            embeds: [
                                embed.setDescription(`${client.emoji.tick} | Successfully started unlocking all channnels.`),
                            ],
                            components: [],
                        });
                        collector.stop();
            ...
            return message.channel.send({
                embeds: [
                    embed.setDescription(`${client.emoji.cross} | There is already a Unlock all process is going on in the server.`)
                        .setColor(client.color),
                ],
            });
        }
...
//# sourceMappingURL=unlockall.js.map