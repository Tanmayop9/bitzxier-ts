...
export default {
    ...
    run: async (client, message, args) => {
        ...
        if (require === 'mod') {
            const mod = await message.guild.members.fetch().then(members => members.filter(member => member.permissions.has('KickMembers') &&
