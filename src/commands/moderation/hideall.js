    ...
    run: async (client, message, args) => {
        ...
        if (!message.guild.Hideall) {
            ...
            interactionMessage.edit({
                embeds: [
                    embed.setDescription(`**Are you sure you want to hide all channels to in this server?**`),
                ], components: [row],
            });
            ...
            collector.on('collect', async (interaction) => {
                if (interaction.isButton()) {
                    if (interaction.customId === 'yes_button') {
                        interactionMessage.edit({
                            embeds: [
                                embed.setDescription(`${client.emoji.tick} | Successfully started hiding to all channnels.`),
                            ],
                            components: [],
                        });
                        collector.stop();
            ...
            return message.channel.send({
                embeds: [
                    embed.setDescription(`${client.emoji.cross} | There is already a Hide all process is going on in the server.`)
                        .setColor(client.color),
                ],
            });
        }
...
//# sourceMappingURL=hideall.js.map