...
export default {
    ...
    run: async (client, message, args) => {
        if (!client.config.premium.includes(message.author.id))
            return;
        ...
        if (!args[0]) {
            return message.channel.send({
                embeds: [embed
                        .setDescription(`${client.emoji.cross} **Invalid Usage**\n\n` +
        ...
        if (!isPremium) {
            return message.channel.send({
                embeds: [embed.setDescription(`${client.emoji.cross} **Not Premium**\n\n` +
        ...
        return message.channel.send({
            embeds: [
                embed
                    ...
                    .setDescription(`Successfully updated premium settings for ${user.tag}\n\n` +
...
//# sourceMappingURL=updatepremium.js.map