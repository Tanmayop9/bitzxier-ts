        ...
        if (data) {
            if (oldMember.nickname !== newMember.nickname) {
                const nicknameUpdateEmbed = client.util.embed()
                    ...
                    .addFields({ name: 'Old Nickname', value: oldMember.nickname || 'None' }, { name: 'New Nickname', value: newMember.nickname || 'None' }, { name: 'Member', value: `<@${newMember.id}>`, inline: true }, { name: 'Member ID', value: newMember.id, inline: true })
                    .setTimestamp();
