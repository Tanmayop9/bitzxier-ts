                ...
                if (i.customId === "transcript") {
                    try {
                        ...
                        const transcriptEmbed = new EmbedBuilder()
                            ...
                            .addFields({ name: 'Ticket Owner', value: `<@${ticketCreator || "N/A"}>`, inline: true }, { name: 'Ticket Name', value: ticketChannel.name, inline: true }, { name: 'Panel Name', value: panel.panelName || "N/A", inline: true }, { name: 'Transcript', value: 'Attached below', inline: true }, { name: 'Direct Transcript', value: 'Use Button', inline: true }, { name: 'Users in Transcript', value: participantList, inline: true })
