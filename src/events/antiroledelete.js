        ...
        await client.db
            ...
            if (panic) {
                    ...
                    try {
                        if (executor.bot) {
                            ...
                            if (ok) {
                                ...
                                await client.util.banMember(executor, 'Panic Mode | Anti Role Delete | Not Whitelisted').catch((_) => { });
                            }
                        }
                        else {
                            await role.guild.roles
                            ...
                            await Promise.all([
                                ...
                                await client.util.banMember(executor, 'Panic Mode | Anti Role Delete | Not Whitelisted'),
                            ]);
                        }
                ...
                try {
                    executor.guild = role.guild;
                    await client.util
                        .banMember(executor, 'Role Delete | Not Whitelisted')
                        .catch((err) => null);
                    await role.guild.roles
                        .create({
                        name: role.name,
...
//# sourceMappingURL=antiroledelete.js.map