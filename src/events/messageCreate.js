    ...
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            if (upremend && Date.now() >= upremend) {
                let upremcount = (await client.db.get(`upremcount_${message.author.id}`))
                ...
                message.author
                    ...
                    embeds: [
                        client.util.embed()
                            ...
                            .setDescription(`Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/bitzxier) was removed.\nClick [here](https://discord.gg/bitzxier) To Buy [Premium](https://discord.gg/bitzxier).`)
                    ],
                    components: [premrow]
                })
                    .catch((err) => { });
            ...
            if (spremend && Date.now() >= spremend) {
                    ...
                    try {
                        await client.users.cache
                            ...
                            embeds: [
                                client.util.embed()
                                    .setColor(client.color)
                                    .setDescription(`Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/bitzxier) was removed.\nClick [here](https://discord.gg/bitzxier) To Buy [Premium](https://discord.gg/bitzxier).`)
                            ],
                            components: [premrow]
                        })
                            .catch((er) => { });
                ...
                message.channel
                    ...
                    embeds: [
                        client.util.embed()
                            .setColor(client.color)
                            .setDescription(`The Premium Of This Server Has Got Expired.\nClick [here](https://discord.gg/bitzxier) To Buy [Premium](https://discord.gg/bitzxier).`)
                    ],
                    components: [premrow]
                })
                    .catch((err) => { });
            ...
            const row = new ActionRowBuilder().addComponents(new ButtonBuilder()
                ...
                .setURL(`https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot`), new ButtonBuilder()
                .setLabel(`Support`)
                .setStyle(ButtonStyle.Link)
            ...
            if (blacklistdb.includes(message.author.id) &&
                !client.config.owner.includes(message.author.id)) {
                return;
            }
            if (message.content === `<@${client.user.id}>`) {
                if (mcooldown.has(message.author.id))
                    return; // Ignore repeated mentions
            ...
            if (customdata) {
                for (const [index, data] of customdata.names.entries()) {
                    if ((!datab.includes(message.author.id) && message.content.startsWith(prefix1) && cmd === data) ||
                        ...
                        if (ignore.channel.includes(message.channel.id) &&
                            ...
                            const msg = await message.channel.send({
                                embeds: [
                                    client.util.embed()
                                        .setColor(client.color)
                                        .setDescription(`This channel is currently in my ignore list, so commands can't be executed here. Please try another channel or reach out to the server Administrator for assistance.`)
                                ]
                            });
                            ...
                            await message.channel.send({
                                ...
                                embeds: [
                                    client.util.embed()
                                        ...
                                        .setDescription(`To enable custom commands, you need to set up a specific role that users must have to access these commands.\nUse the command to set the required role: \n\`${message.guild.prefix}setup reqrole @YourRequiredRole/id\``)
                                        .setTimestamp()
                                ]
                            });
                            return;
                            ...
                            await message.channel.send({
                                ...
                                embeds: [
                                    client.util.embed()
                                        ...
                                        .setDescription(`This action is taken to maintain consistency. Please ensure that server roles are managed appropriately.`)
                        ...
                        if (!role) {
                            ...
                            await message.channel.send({
                                ...
                                embeds: [
                                    client.util.embed()
                                        ...
                                        .setDescription(`To maintain accurate records, the associated data is being removed. Ensure roles are managed properly to prevent future issues.`)
                            ...
                            collector.on('collect', async (interaction) => {
                                if (interaction.user.id !== message.author.id) {
                                    ...
                                    await sendRoleLog(message, 'Permissions Removed', role, null, 'All permissions cleared for security');
                                    await interaction.reply({
                                        embeds: [
                                            client.util.embed()
                                                .setColor(client.color)
                                    ...
                                    await interaction.reply({
                                        embeds: [
                                            client.util.embed()
                                                .setColor(client.color)
                                                .setDescription(`${client.emoji.cross} | I don't have sufficient permissions to clear permissions from the role. Please make sure my role position is higher than the role you're trying to modify.`)
                                        ],
                                        ephemeral: true // Only visible to the user who clicked the button
                                    });
                                }
                            ...
                            if (!role.editable) {
                                await message.channel.send({
                                    embeds: [
                                        client.util.embed()
                                            .setColor(client.color)
                                            .setDescription(`${client.emoji.cross} | I can't provide this role as my highest role is either below or equal to the provided role.`)
                                    ]
                                });
                            }
                            else if (member.roles.cache.has(role.id)) {
                                await member.roles.remove(role.id, `${message.author.tag} | ${message.author.id}`);
                                await sendRoleLog(message, 'Role Removed', role, member);
                                await message.channel.send({
                                    embeds: [
                                        client.util.embed()
                                            .setColor(client.color)
                                ...
                                await sendRoleLog(message, 'Role Added', role, member);
                                await message.channel.send({
                                    embeds: [
                                        client.util.embed()
                                            .setColor(client.color)
            ...
            if (command.premium || false) {
                if (!client.config.owner.includes(message.author.id) && !uprem && !sprem) {
                    ...
                    embeds
                        .setDescription('[Click here to buy Premium](https://discord.gg/bitzxier) so that you can use this command.')
                        .setColor(client.color);
                    return message.channel.send({
            ...
            if (command) {
                ...
                const commandlog = new EmbedBuilder()
                    ...
                    .setTimestamp()
                    .setDescription(`Command Ran In: \`${message.guild.name} | ${message.guild.id}\`\n` +
